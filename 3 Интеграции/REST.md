...
- **PATCH-запрос:** PATCH-запросы не идемпотентны, потому что они могут обновлять только отдельные части ресурса. Если вы отправите PATCH-запрос несколько раз, могут произойти нежелательные изменения.
